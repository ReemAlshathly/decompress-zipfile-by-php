<?php
 ...
 {  
      ...
      {  
                ...
                {  
                    ...
                    //  foreach($files as $file) 
                     ...
                     {  
                          $tmp=explode(".", $file);
                          $file_ext = end($tmp);  
                          $allowed_ext = array('jpg', 'png','JPG','','mp3','pdf');  
                          if(in_array($file_ext, $allowed_ext))  
                          {  
                               $new_name = md5(rand()).'.' . $file_ext;  
                               $output .= '<div class="col-md-12"><div style="padding:16px; border:1px solid #CCC;">
                               <img src="upload/'.$new_name.'" width="170" height="240" /></div></div>
           ...
           <a download="" href="upload/'.$new_name.'">text</a>
                               ';  
